 ...
 */
public class PriorityQueue4LianXi<E extends Priority> implements Queue<E> {

    Priority[] array;
    int size;

    public PriorityQueue4LianXi(int capacity) {

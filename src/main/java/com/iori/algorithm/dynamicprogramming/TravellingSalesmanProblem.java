    ...
    /*
        ...
        北京->上海->
         ...
         g1
          ...
          d(0,1|2|3) => g1[0][1] + d(1,2|3) => g1[1][3] + d(3,2) => g1[3][2] + d(2,空)
                                                                            g1[2][0]
                                           => g1[1][2] + d(2,3) => g1[2][3] + d(3,空)
                                                                            g1[3][0]
                        g1[0][2] + d(2,1|3) => g1[2][1] + d(1,3) => g1[1][3] + d(3,空)
                                                                            g1[3][0]
                                           => g1[2][3] + d(3,1) => g1[3][1] + d(1,空)
                                                                            g1[1][0]
                        g1[0][3] + d(3,1|2) => g1[3][1] + d(1,2) => g1[1][2] + d(2,空)
                                                                            g1[2][0]
                                           => g1[3][2] + d(2,1) => g1[2][1] + d(1,空)
                                                                            g1[1][0]
          ...
          d(0,1|2) => g1[0][1] + d(1,2)
                   => g1[0][2] + d(2,1)
          d(1,1|2)
          d(2,1|2)
          d(3,1|2) => g1[3][1] + d(1,2)
                   => g1[3][2] + d(2,1)
     */
